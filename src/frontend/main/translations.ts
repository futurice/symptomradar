...
export default {
  en: {
    ...
    main: {
      ...
      goToMap: 'Go to map',
      selectTwoSymptomsToCompare: 'Select two symptoms to compare their development over time.',
...
The information was collected using a questionnaire form. This site displays the results of the questionnaire. <2>Read more about the privacy policy (in Finnish).</2>
    ...
    main: {
      ...
      goToMap: 'Karttaan',
      selectTwoSymptomsToCompare: 'Valitse kaksi oiretta vertaillaksesi niiden kehitystä aikajanalla.',
